...
def main(data_path, csv_path, p_timesteps, w_timesteps=1, layer=1, epochs=10,
    ...
    new_overview = pd.concat([old_overview, overview], axis=0, ignore_index=True,sort = True)
...
#/Users/Array/PycharmProjects/Bachelor/LSTM/ANN_Version2.py -E 5 -N 20 -B 64 -F 1 -GR 7 -PT TR1_1_DftL1 -WT TR1_1_DftL1